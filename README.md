<!--
  GitHub Profile README — Bhaskar Aanjana
  Repo must stay public and named: bhaskaraanjana/bhaskaraanjana
-->
...
[![Location](https://img.shields.io/badge/St._John's%2C_NL-0ea5e9?style=for-the-badge&logo=googlemaps&logoColor=white)](https://github.com/bhaskaraanjana)
...
|--------|------------|--------|
| **[NeuralBox](https://github.com/bhaskaraanjana/NeuralBox)** | Run AI models in the browser — private, WebGPU/WASM, no sign-up | [Live](https://neuralbox.vercel.app) · [neuralbox.infinitemind.space](https://neuralbox.infinitemind.space) |
...
Research, robotics, data viz, and smaller product experiments beyond the main suite.

| Project | What it is | Link |
|---------|------------|------|
| **[Orbital Ecosystem Viz](https://github.com/bhaskaraanjana/Our-Fragile-Orbital-Ecosystem-Visualisation)** | Earth’s crowded orbit — satellite/debris catalogs → Jupyter infographic + dashboard | [Repo](https://github.com/bhaskaraanjana/Our-Fragile-Orbital-Ecosystem-Visualisation) |
| **[Ball Balancing RL](https://github.com/bhaskaraanjana/Simulated-Ball-Balancing-RL)** | PPO agent balances a ball on a tilting table in Gazebo + ROS Noetic (MUN COMP3766) | [Repo](https://github.com/bhaskaraanjana/Simulated-Ball-Balancing-RL) |
| **[Smart Outfit Assistant](https://github.com/bhaskaraanjana/Smart-Outfit-Assistant)** | Skin-tone & color-theory outfit curation from live retail scrapes (Next.js + Puppeteer) | [Repo](https://github.com/bhaskaraanjana/Smart-Outfit-Assistant) |

---

### What I'm building toward

- **Local-first by default** — useful offline, honest about what leaves the device  
- **Voice & spatial UX** — hands-free logging, infinite canvases, low-friction capture  
- **Private AI for regulated work** — air-gapped / on-prem paths for compliance-heavy teams (Aegis)  
- **Ship, measure, refine** — product craft over demo-ware  
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,react,vite,nodejs,python,postgres,firebase,supabase,tailwind,git,vercel,docker&perline=6" alt="Tech stack" />
</p>
...
<sub>Built with intent · St. John's, Newfoundland & Labrador</sub>
